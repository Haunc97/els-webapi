...
{
    public abstract class ELSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ELSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ELSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ELSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ELSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ELSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ELSDbContext, Task<T>> func)
        {
            T result;
